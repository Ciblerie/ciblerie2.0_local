...
import '../main.dart'; // Importez le fichier où vous avez défini globalScores
...
class DevScreen extends StatelessWidget {
  ...
  void _startGame(BuildContext context, String group) async {
    ...
    // 3. Réinitialisation des scores
    globalScores = [0, 0, 0, 0]; // Réinitialise les scores

    // 4. Redirection immédiate vers ScoresScreen
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (_) => ScoresScreen()),
    );

    // 5. Forcer l'état initial (optionnel)
