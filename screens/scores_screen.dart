...
class _ScoresScreenState extends State<ScoresScreen> with TickerProviderStateMixin {
  ...
  // int _currentPlayerIndex = 0; // Supprimé car non utilisé
  // int? _currentRound; // Supprimé car non utilisé
  ...
  // late Animation<double> _blinkAnimation; // Supprimé car non utilisé
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          // Bouton "Attente groupe"
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 8.0),
            child: ElevatedButton(
              onPressed: null,
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFF7DBFF8), // Bleu comme demandé
                disabledBackgroundColor: const Color(0xFF7DBFF8),
                elevation: 0,
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(20),
