...
class _ScoresScreenState extends State<ScoresScreen> with TickerProviderStateMixin {
  ...
  String _attenteGroupeButtonText = 'Attente groupe';
  ...
  void _onStartGamePressed() {
    final ws = Provider.of<WebSocketService>(context, listen: false);
    ws.sendMessage(json.encode({'type': 'START_CONFIRMED', 'message': 'START_CONFIRMED'})); // Modification ici
  }
