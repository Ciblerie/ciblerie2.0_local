                ...
                buildGameSection(
                  ...
                  children: [
                    ...
                    buildLevelRow('Semi-pro', [
                      buildButton(context, 'Semi-pro 1J', 'SP1'),
                      buildButton(context, 'Semi-pro 2J', 'SP2'),
                      buildButton(context, 'Semi-pro 3J', 'SP3'),
                      buildButton(context, 'Semi-pro 4J', 'SP4'),
                    ]),
                    buildLevelRow('Pro', [
                      buildButton(context, 'Pro 1J', 'P1'),
                      buildButton(context, 'Pro 2J', 'P2'),
                      buildButton(context, 'Pro 3J', 'P3'),
                      buildButton(context, 'Pro 4J', 'P4'),
                    ]),
                    buildLevelRow('Champion', [
                      buildButton(context, 'Champion 1J', 'C1'),
                      buildButton(context, 'Champion 2J', 'C2'),
                      buildButton(context, 'Champion 3J', 'C3'),
                      buildButton(context, 'Champion 4J', 'C4'),
                    ]),
                    buildLevelRow('Légende', [
                      buildButton(context, 'Légende 1J', 'L1'),
                      buildButton(context, 'Légende 2J', 'L2'),
                      buildButton(context, 'Légende 3J', 'L3'),
                      buildButton(context, 'Légende 4J', 'L4'),
                    ]),
                  ],
                ),
                buildGameSection(
