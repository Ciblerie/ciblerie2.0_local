...
void CC4(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameC4();}     
  if (partieEnCours==true){trtPartieEnCoursC4();} 
  if (partieFinie==true){trtPartieFinieC4();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieC4(){   
    FinGame();  
