...
void CP2(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameP2();}     
  if (partieEnCours==true){trtPartieEnCoursP2();} 
  if (partieFinie==true){trtPartieFinieP2();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieP2(){
    FinGame();   
