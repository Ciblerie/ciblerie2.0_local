...
void CP3(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameP3();}     
  if (partieEnCours==true){trtPartieEnCoursP3();} 
  if (partieFinie==true){trtPartieFinieP3();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieP3(){
    FinGame();   
