...
void CC3(){ //------------------------------------------------------------------------------------
  ...
  indexgroupe = 3;  // Toujours revenir au groupe C avant le début de chaque partie
  AcquisitionCapteurs();
  if (initialisation==true){InitGameC3();}     
  if (partieEnCours==true){trtPartieEnCoursC3();} 
  if (partieFinie==true){trtPartieFinieC3();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieC3(){
    FinGame();   
