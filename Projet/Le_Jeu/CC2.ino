...
void CC2(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameC2();}     
  if (partieEnCours==true){trtPartieEnCoursC2();} 
  if (partieFinie==true){trtPartieFinieC2();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieC2(){  
    FinGame();   
