...
void CP4(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameP4();}     
  if (partieEnCours==true){trtPartieEnCoursP4();} 
  if (partieFinie==true){trtPartieFinieP4();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieP4(){
    FinGame();   
