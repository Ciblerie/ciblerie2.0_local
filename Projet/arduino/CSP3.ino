...
void CSP3(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameSP3();}     
  if (partieEnCours==true){trtPartieEnCoursSP3();} 
  if (partieFinie==true){trtPartieFinieSP3();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieSP3(){
    FinGame();   
