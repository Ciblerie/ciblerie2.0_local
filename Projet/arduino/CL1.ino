...
void CL1(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameL();}     
  if (partieEnCours==true){trtPartieEnCoursL();} 
  if (partieFinie==true){trtPartieFinieL();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieL(){  
    FinGame();   
