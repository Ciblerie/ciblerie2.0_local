...
void CL2(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameL2();}     
  if (partieEnCours==true){trtPartieEnCoursL2();} 
  if (partieFinie==true){trtPartieFinieL2();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieL2(){
    FinGame();   
