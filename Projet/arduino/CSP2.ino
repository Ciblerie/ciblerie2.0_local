...
void CSP2(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameSP2();}     
  if (partieEnCours==true){trtPartieEnCoursSP2();} 
  if (partieFinie==true){trtPartieFinieSP2();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieSP2(){
    FinGame();   
