...
void CC1(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameC();}     
  if (partieEnCours==true){trtPartieEnCoursC();} 
  if (partieFinie==true){trtPartieFinieC();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieC(){   
    FinGame();   
