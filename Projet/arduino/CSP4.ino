...
void CSP4(){ //------------------------------------------------------------------------------------
  ...
  AcquisitionCapteurs();
  if (initialisation==true){InitGameSP4();}     
  if (partieEnCours==true){trtPartieEnCoursSP4();} 
  if (partieFinie==true){trtPartieFinieSP4();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieSP4(){   
    FinGame();   
