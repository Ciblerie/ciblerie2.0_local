...
void CL4(){ //------------------------------------------------------------------------------------
  ...
  indexgroupe = 4;  // Toujours revenir au groupe L avant le début de chaque partie
  AcquisitionCapteurs();
  if (initialisation==true){InitGameL4();}     
  if (partieEnCours==true){trtPartieEnCoursL4();} 
  if (partieFinie==true){trtPartieFinieL4();}
}
//---------------------------------------------FIN LOOP-------------------------------

void trtPartieFinieL4(){  
    FinGame();  
